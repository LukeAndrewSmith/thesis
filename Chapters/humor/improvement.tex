...
\TODO{
    JAKOB comment:
    Too many experiments explained in too little space. I get lost by reading trough this. Either try to focus on less experiments or expand a bit. It would also help if they are visuallze a litte bit more apart and perhaps you could even have a conclusion for them. Just a sentence that allows the reader to understand what we have learned from the experiment. Ideally this then motivsates the next experiment.

    The conclusion below is good. 
}
